...
describe("#documents.search", () => {
  ...
  it("should return results in ranked order", async () => {
    ...
    const thirdResult = await (0, _factories.buildDocument)({
      title: "search term",
      text: "random text",
      userId: user.id,
      teamId: user.teamId
...
describe("#documents.restore", () => {
  ...
  it("should not add restored templates to collection structure", async () => {
    ...
    const template = await (0, _factories.buildDocument)({
      teamId: user.teamId,
      collectionId: collection.id,
      template: true
    });
...
describe("#documents.unpublish", () => {
  it("should unpublish a document", async () => {
    ...
    document = await _models.Document.unscoped().findByPk(document.id);
