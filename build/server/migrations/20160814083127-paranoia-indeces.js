...
module.exports = {
  up: async (queryInterface, Sequelize) => {
    ...
    await queryInterface.removeIndex('atlases', ['id', 'teamId']); // Add new ones
    ...
    await queryInterface.addIndex('documents', ['parentDocumentId', 'atlasId', 'deletedAt']);
  ...
  down: async (queryInterface, Sequelize) => {
    ...
    await queryInterface.removeIndex('documents', ['parentDocumentId', 'atlasId', 'deletedAt']);
